...
function Tab2Screen() {
  return (
    <View style={styles.tabContainer}>
      <Text style={styles.tabTitle}>Photo UwU</Text>
      <Image 
        style={{ 
          borderRadius:900/2, //<---Round of the image
          shadowColor: '#FFF',//<-- Some code I found on StackOverflow
...
//--------Exercise 2-------------//
  ...
  const getName =async () => {
    try{
      ...
      if(userStorage != null){
        ...
        console.log("User is empty/weird stuff happened here");
      }
    }
    catch(e){
      console.log(e);
  ...
  return (
    <View style={styles.tabContainer}>
      ...
      <Text style={styles.tabTitle}>User name is {userName}</Text>
    </View>
  );
}
